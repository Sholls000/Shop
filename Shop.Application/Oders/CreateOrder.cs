...
namespace Shop.Application.Oders
{
    ...
    public class CreateOrder
    {
        ...
        public class Request
        {
            ...
            //making Stock inherit the property of Stocks or vice-versa
        ...
        //Creating a randomly generated OrderRef avoiding duplicates by using do...while loop
        //....then saving to database
        public string CreateOrderReference()
        {
            var chars = "ABCDEFGHIJKLMNOPQSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
